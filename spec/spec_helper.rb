...
# We don't enable SimpleCov if we're being loaded by Spring, because the coverage results are a Damn
# Lie in that situation:  Spring loads much of the app before we ever have a chance to initialize,
# and then for many classes we just don't get to see _anything_ in terms of lines of code that are
# subsequently executed.
if defined?(Spring)
  raise "In CI env, but loading via Spring. This breaks coverage analysis!" if ENV["CI"]

  puts "NOTE: No coverage analysis, because Spring gets in the way."
else
  require "simplecov"
