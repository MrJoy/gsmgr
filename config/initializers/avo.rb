...
Avo.configure do |config|
  ...
  # config.cache_resource_filters = ->(current_user:, resource:) { current_user.cache_resource_filters?} # rubocop:disable Layout/LineLength

  ## == Customization ==
  config.app_name = "GSuite ACL Manager"
  # config.timezone = 'UTC'
  # config.currency = 'USD'
